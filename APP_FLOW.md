...
CorpFinity is a corporate wellness platform that helps employees maintain healthy habits through personalized challenges, mood tracking, hydration monitoring, and achievement systems.
...
│    M   T   W   T   F   S   S                                    │
│    █   █   █   █   █   █   █                                    │
│    65% 40% 100% 30% 80% 20% 50%                                 │
│                                                                  │
│  Note: Currently uses static demo data                          │
│                                                                  │
│  Future Backend API:                                             │
│    GET /api/insights/weekly-activity                            │
│      Response: {                                                │
│        monday: 3,                                               │
│        tuesday: 2,                                              │
│        wednesday: 5,                                            │
...
│           COUNT(*) as count                                     │
│    FROM challenge_history                                       │
│    WHERE user_id = ? AND completed_at >= NOW() - INTERVAL '7d'  │
│    GROUP BY day                                                 │
└─────────────────────────────────────────────────────────────────┘
```
